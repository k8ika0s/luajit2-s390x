...
local function run(n)
  local total = 0
  for i = 1, n do
    total = total + tonumber(lib.sum_varargs_strlen(u64(i), 7, "a", "bb",
                                                    "ccc", "dddd", "eeeee",
                                                    "ffffff", "ggggggg"))
  end
  return total
...
t.eq(actual, expected, "ffi string vararg total")
t.truthy(t.find_trace_event(capture.events, "stop"), "ffi string vararg traced")
