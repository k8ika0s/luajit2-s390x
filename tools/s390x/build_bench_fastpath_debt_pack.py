...
PROFILE_XCFLAGS = {
    ...
    "component-loop-off": " -DLUAJIT_ENABLE_S390X_COMPONENT_LOOP_REDUCERS=0",
    "mixed-noffi-off": " -DLUAJIT_ENABLE_S390X_COMPONENT_LOOP_REDUCERS=0",
    "iterator-table-off": " -DLUAJIT_ENABLE_S390X_ITERATOR_TABLE_REDUCER=0",
