...
DEFAULT_ON_KNOWN = {
    ...
    "LUAJIT_S390X_DISABLE_ITERATOR_ARRAY_ITERN_NOJIT_HOTCOUNT_PARK",
    "LUAJIT_S390X_DISABLE_ITERATOR_HASH_ITERN_NOJIT_HOTCOUNT_PARK",
    "LUAJIT_S390X_DISABLE_ITERATOR_ITERN_PROTO_NOJIT",
    "LUAJIT_S390X_DISABLE_ITERATOR_POST_PROTO_ITERN_NOHOT",
    "LUAJIT_S390X_DISABLE_MANUAL_FIND",
    "LUAJIT_S390X_DISABLE_MANUAL_FIND_CYCLE",
    "LUAJIT_S390X_DISABLE_MISS_FIND",
    "LUAJIT_S390X_DISABLE_NARROW_XSTORE",
    "LUAJIT_S390X_DISABLE_PREFIX_EQ",
    ...
    "LUAJIT_S390X_DISABLE_STRING_KEY_LOOKUP",
...
RETAINED_NOTES = {
    ...
    "LUAJIT_S390X_ITERATOR_ITERL_BLACKLIST":
        "Retained broad iterator ITERL rail; zkd0 mixed_noffi rejects removal.",
}
